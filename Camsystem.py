...
from MotionDetection import detectmot
    ...
    def run(self):
        while True:
            ...
            if len(os.listdir(directory)) != 0:  # to avoid error while the script is running on the background
                ...
                video_capture = cv2.VideoCapture('http://192.168.125.177:8080//video')#here we input the ip address of cam2
                count = 0
                user1 = ""
                user2 = ""
                ...
                for filename in os.listdir(directory):
                    User1 = face_recognition.load_image_file(
                        "C:/Users/appli/PycharmProjects/IntruderFaceDetection/DataSet/" + str(filename))
                    user1 = str(filename)
                    print(user1)
                    break
                ...
                for filename in os.listdir(directory):
                    if count == 1:
                        User2 = face_recognition.load_image_file(
                            "C:/Users/appli/PycharmProjects/IntruderFaceDetection/DataSet/" + str(filename))
                        user2 = str(filename)
                        break
                    else:
                        ...
                        user2 = str(filename)
                    count += 1
                User2_face_encoding = face_recognition.face_encodings(User2)[0]
                            ...
                            if name == "Unknown":
                                ...
                                if countWrongf == 6:
                                    ...
                                    while x > 0:
                                        ...
                                        x -= 1
                                    cv2.imwrite('voleur/intruder.jpg',
                                                frame)
                                    SendMail('voleur/intruder.jpg','Time_of_movements.csv')
